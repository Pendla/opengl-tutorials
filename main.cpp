...
int main() {
    ...
    if (!vertexShaderCompilationSuccess) {
        ...
        std::cout << "ERROR - VERTEX_SHADER (COMPILATION FAILED):" << std::endl << infoLog << std::endl;
    }
    ...
    if (!fragmentShaderCompilationSuccess) {
        ...
        std::cout << "ERROR - FRAGMENT_SHADER (COMPILATION FAILED):" << std::endl << infoLog << std::endl;
    }
    ...
    if (!shaderProgramLinkingSuccess) {
        ...
        std::cout << "ERROR - SHADER_PROGRAM (LINKING FAILED):" << std::endl << infoLog << std::endl;
    }
